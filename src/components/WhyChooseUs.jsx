...
const features = [
   {
      ...
      icon: (
         <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22 17L13.5 8.5L8.5 13.5L2 7" stroke="var(--brand)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M16 17H22V11" stroke="var(--brand)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
         </svg>
      ),
   },
   {
      ...
      icon: (
         <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
               ...
               strokeLinejoin="round"
            />
            <path d="M21 3L22 14H20" stroke="var(--brand)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path
               ...
               strokeLinejoin="round"
            />
            <path d="M3 4H11" stroke="var(--brand)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
         </svg>
      ),
   },
   {
      ...
      <section className="w-full px-4 md:px-8 lg:px-10 py-16 lg:py-24 bg-slate-50">
         <div className="max-w-360 mx-auto w-full flex flex-col gap-12">
            ...
            <div className="flex flex-col items-center gap-4">
               ...
               <p className="text-center text-neutral-700 text-base md:text-lg font-light leading-relaxed md:leading-7">
                  ...
                  {translatedFeatures.map((f) => (
                     ...
                     >
                        ...
                        <div className="flex flex-col gap-2 flex-1">
                           ...
                           <p className="text-neutral-700 text-sm sm:text-base font-light leading-relaxed sm:leading-6">{f.desc}</p>
                        </div>
                     </div>
                  ))}
               </div>
