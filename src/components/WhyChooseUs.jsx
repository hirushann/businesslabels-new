...
const features = [
   {
      ...
      icon: (
         <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M22 17L13.5 8.5L8.5 13.5L2 7" stroke="#F18800" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path d="M16 17H22V11" stroke="#F18800" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
         </svg>
      ),
   },
   {
      ...
      icon: (
         <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path
               ...
               strokeLinejoin="round"
            />
            <path d="M21 3L22 14H20" stroke="#F18800" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            <path
               ...
               strokeLinejoin="round"
            />
            <path d="M3 4H11" stroke="#F18800" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
         </svg>
      ),
   },
   {
            ...
            <div className="flex flex-col lg:flex-row gap-12 lg:items-center">
               ...
               <div className="w-full lg:flex-1 flex flex-col gap-6">
                  {translatedFeatures.map((f) => (
                     ...
                     >
                        {/* Icon box */}
                        <div className="p-4 bg-orange-50 rounded-lg shadow-sm flex items-center justify-center shrink-0">{f.icon}</div>
