    ...
    <div className="p-6 bg-white rounded-xl shadow-[2px_4px_20px_0px_rgba(109,109,120,0.06)] outline outline-1 outline-offset-[-1px] outline-slate-100 flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-3">
        <div className="flex justify-between items-center">
          <span className="text-blue-400 text-base font-normal leading-5">SKU: EP-C3500</span>
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-neutral-800 text-4xl font-bold leading-[48px]">€2.302,30</span>
          <span className="text-zinc-500 text-2xl font-normal line-through leading-7">€3.302,67</span>
          <span className="text-red-600 text-2xl font-semibold leading-7">-24%</span>
        </div>
      ...
      <div className="p-4 bg-slate-100 rounded-[10px]">
        <div className="flex gap-3">
          <span className="text-neutral-800 text-base font-bold leading-5 w-20">Bulk Discounts</span>
