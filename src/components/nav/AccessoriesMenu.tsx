          ...
          <div className="flex-1 w-full flex flex-col">
            {menuItems.map((item, i) => (
              ...
              >
                ...
                <svg
                  className="w-5 h-5 text-neutral-400 flex-shrink-0 group-hover:translate-x-1 group-hover:text-brand transition-all"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  strokeWidth="1.5"
          ...
          {/* <div className="w-full lg:w-72 self-stretch p-4 bg-white rounded-xl shadow-[2px_4px_20px_0px_rgba(109,109,120,0.06)] outline outline-1 outline-offset-[-1px] outline-gray-100 inline-flex flex-col justify-start items-start gap-5 overflow-hidden">
            <div className="self-stretch h-40 relative rounded-lg overflow-hidden bg-gray-100">
              <Image
                ...
                alt={t('common.menuFeaturedTitle')}
                fill
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              <div className="w-48 text-neutral-800 text-base font-semibold leading-5">
                {t('common.menuFeaturedTitle')}
              </div>
              <div className="self-stretch flex flex-col justify-start items-start gap-3">
                ...
                <Link href="/resources/knowledge-base" className="self-stretch inline-flex justify-start items-end gap-2 group">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8 5.33334C11.3137 5.33334 14 4.43791 14 3.33334C14 2.22877 11.3137 1.33334 8 1.33334C4.68629 1.33334 2 2.22877 2 3.33334C2 4.43791 4.68629 5.33334 8 5.33334Z" stroke="var(--brand)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 3.33334V12.6667C2 13.1971 2.63214 13.7058 3.75736 14.0809C4.88258 14.456 6.4087 14.6667 8 14.6667C9.5913 14.6667 11.1174 14.456 12.2426 14.0809C13.3679 13.7058 14 13.1971 14 12.6667V3.33334" stroke="var(--brand)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/><path d="M2 8C2 8.53043 2.63214 9.03914 3.75736 9.41421C4.88258 9.78929 6.4087 10 8 10C9.5913 10 11.1174 9.78929 12.2426 9.41421C13.3679 9.03914 14 8.53043 14 8" stroke="var(--brand)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                  <span className="text-neutral-700 text-sm font-normal leading-5 group-hover:text-brand transition-colors">
