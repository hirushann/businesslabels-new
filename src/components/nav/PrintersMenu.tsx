...
export default function PrintersMenu({ canonicalUrls = {} }: { canonicalUrls?: CategoryCanonicalUrlsById }) {
  ...
  return (
    <div className="w-[90vw] max-w-[832px] inline-flex flex-col justify-start items-start">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-start items-start gap-6">
          ...
          <div className="flex-1 w-full flex flex-col">
            {menuItems.map((item, i) => (
              <Link
                key={item.titleKey}
                href={getPrinterCategoryPath(locale, item.categoryKey, canonicalUrls)}
      ...
      {/* Bottom CTA bar */}
      <Link
        href={getPrinterCategoryPath(locale, 'root', canonicalUrls)}
