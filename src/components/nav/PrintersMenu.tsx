...
const menuItems = [
  {
    ...
    href: '/product-category/labelprinters/color-labelprinters',
    icon: (
  ...
  },
  {
    ...
    href: '/product-category/labelprinters/thermal-labelprinters',
    icon: (
  ...
  },
  {
    ...
    href: '/product-category/labelprinters/starterkits',
    icon: (
  ...
  },
  {
    ...
    href: '/product-category/labelprinters/consumables',
    icon: (
