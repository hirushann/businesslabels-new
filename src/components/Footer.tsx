...
const trustItems = [
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M26.6667 35V31.6667C26.6667 29.8986 25.9643 28.2029 24.7141 26.9526C23.4638 25.7024 21.7681 25 20 25H10C8.2319 25 6.53621 25.7024 5.28597 26.9526C4.03572 28.2029 3.33334 29.8986 3.33334 31.6667V35" stroke="#F18800" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M15 18.3333C18.6819 18.3333 21.6667 15.3486 21.6667 11.6667C21.6667 7.98477 18.6819 5 15 5C11.3181 5 8.33334 7.98477 8.33334 11.6667C8.33334 15.3486 11.3181 18.3333 15 18.3333Z" stroke="#F18800" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M36.6667 35.0001V31.6668C36.6656 30.1897 36.1739 28.7548 35.269 27.5873C34.364 26.4199 33.0969 25.5861 31.6667 25.2168" stroke="#F18800" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M26.6667 5.2168C28.1007 5.58397 29.3717 6.41797 30.2794 7.58731C31.1871 8.75666 31.6798 10.1948 31.6798 11.6751C31.6798 13.1554 31.1871 14.5936 30.2794 15.7629C29.3717 16.9323 28.1007 17.7663 26.6667 18.1335" stroke="#F18800" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
  {
  ...
  },
  {
    ...
    icon: (
      <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M23.3334 29.9998V9.99984C23.3334 9.11578 22.9822 8.26794 22.3571 7.64281C21.7319 7.01769 20.8841 6.6665 20 6.6665H6.66671C5.78265 6.6665 4.93481 7.01769 4.30968 7.64281C3.68456 8.26794 3.33337 9.11578 3.33337 9.99984V28.3332C3.33337 28.7752 3.50897 29.1991 3.82153 29.5117C4.13409 29.8242 4.55801 29.9998 5.00004 29.9998H8.33337" stroke="#F18800" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M25 30H15" stroke="#F18800" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M31.6667 30.0002H35C35.4421 30.0002 35.866 29.8246 36.1786 29.512C36.4911 29.1994 36.6667 28.7755 36.6667 28.3335V22.2502C36.666 21.8719 36.5367 21.5052 36.3 21.2102L30.5 13.9602C30.3442 13.765 30.1464 13.6073 29.9214 13.4988C29.6964 13.3904 29.4498 13.3339 29.2 13.3335H23.3334" stroke="#F18800" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M28.3333 33.3332C30.1743 33.3332 31.6667 31.8408 31.6667 29.9998C31.6667 28.1589 30.1743 26.6665 28.3333 26.6665C26.4924 26.6665 25 28.1589 25 29.9998C25 31.8408 26.4924 33.3332 28.3333 33.3332Z" stroke="#F18800" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/><path d="M11.6667 33.3332C13.5077 33.3332 15 31.8408 15 29.9998C15 28.1589 13.5077 26.6665 11.6667 26.6665C9.82576 26.6665 8.33337 28.1589 8.33337 29.9998C8.33337 31.8408 9.82576 33.3332 11.6667 33.3332Z" stroke="#F18800" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
];
