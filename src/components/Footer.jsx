...
const footerLinks = {
  Products: [
    { name: 'Label Printers', href: '/category/labelprinters' },
    { name: 'Label Rolls', href: '/category/labels-en-tickets' },
    { name: 'Ink & Supplies', href: '/category/inkt-cartridges-nl' },
    { name: 'Special Labels', href: '/category/specials' },
  ],
  'Popular Printers': [
  ...
  'Support & Services': [
    { name: 'Expert Advice', href: '/support/expert' },
    { name: 'Test Printer Loan', href: '/support/loan' },
    { name: 'Sample Prints', href: '/support/samples' },
    { name: 'Ink Calculator', href: '/resources/ink-calculator' },
        ...
        <div className="max-w-[1512px] mx-auto w-full px-10 flex gap-8">
          ...
          <div className="w-[480px] flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-end gap-2">
                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M11.334 13.6663H4.66732C2.66732 13.6663 1.33398 12.6663 1.33398 10.333V5.66634C1.33398 3.33301 2.66732 2.33301 4.66732 2.33301H11.334C13.334 2.33301 14.6673 3.33301 14.6673 5.66634V10.333C14.6673 12.6663 13.334 13.6663 11.334 13.6663Z" stroke="white" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/><path d="M11.3327 6L9.24601 7.66667C8.55935 8.21333 7.43268 8.21333 6.74601 7.66667L4.66602 6" stroke="white" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
                <Link href="mailto:verkoop@businesslabels.nl" className="text-slate-100 text-sm font-semibold lowercase leading-5 hover:text-white transition-colors">
          ...
          {Object.entries(footerLinks).map(([title, links]) => (
            <div key={title} className="w-56 flex flex-col gap-5">
              <Link 
                href={title === 'Products' ? '/products' : '#'} 
                className={`text-white text-lg font-semibold font-['Segoe_UI'] leading-6 ${title === 'Products' ? 'hover:text-amber-500 transition-colors' : 'pointer-events-none'}`}
              >
                {title}
              </Link>
              <div className="flex flex-col gap-4">
