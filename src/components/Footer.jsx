...
const trustItems = [
  {
    titleKey: 'footer.trust.epsonTitle',
  ...
  {
    titleKey: 'footer.trust.customersTitle',
  ...
  {
    titleKey: 'footer.trust.secureTitle',
  ...
  {
    titleKey: 'footer.trust.shippingTitle',
            ...
            <div className="flex flex-col gap-4">
              ...
              <div>
                ...
                <a 
                  ...
                  className="group flex items-start gap-2 mt-3 text-white/80 hover:text-white transition-colors"
                >
                  ...
                  <address className="not-italic text-base font-light leading-5 group-hover:underline">
