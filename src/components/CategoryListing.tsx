...
const CATEGORY_SEARCH_QUERY = {
  ...
  result_fields: {
    ...
    stock: { raw: {} },
    in_stock: { raw: {} },
    delivery_dates_in_stock: { raw: {} },
    delivery_dates_no_stock: { raw: {} },
    main_image: { raw: {} },
    categories: { raw: {} },
    material: { raw: {} },
    material_title: { raw: {} },
...
function CategorySkeletonGrid({ isSidebarOpen }: { isSidebarOpen: boolean }) {
  return (
    <div className={`grid grid-cols-1 gap-6 sm:grid-cols-2 ${isSidebarOpen ? "lg:grid-cols-2" : "lg:grid-cols-3"}`}>
            ...
            <>
              <div
                className={`grid grid-cols-1 gap-6 sm:grid-cols-2 ${
                  isSidebarOpen ? "lg:grid-cols-2" : "lg:grid-cols-3"
                }`}
              >
                {hasSearchProducts
