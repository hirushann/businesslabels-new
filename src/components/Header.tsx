          ...
          <div className="flex items-center gap-8">
            <div className="flex items-end gap-2">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9.33398 12.0003V4.00033C9.33398 3.6467 9.19351 3.30756 8.94346 3.05752C8.69341 2.80747 8.35427 2.66699 8.00065 2.66699H2.66732C2.3137 2.66699 1.97456 2.80747 1.72451 3.05752C1.47446 3.30756 1.33398 3.6467 1.33398 4.00033V11.3337C1.33398 11.5105 1.40422 11.68 1.52925 11.8051C1.65427 11.9301 1.82384 12.0003 2.00065 12.0003H3.33398" stroke="#F1F4F8" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M10 12H6" stroke="#F1F4F8" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M12.6673 11.9997H14.0007C14.1775 11.9997 14.347 11.9294 14.4721 11.8044C14.5971 11.6794 14.6673 11.5098 14.6673 11.333V8.89967C14.667 8.74838 14.6153 8.60168 14.5207 8.48367L12.2007 5.58367C12.1383 5.50559 12.0592 5.44253 11.9692 5.39914C11.8792 5.35575 11.7806 5.33315 11.6807 5.33301H9.33398" stroke="#F1F4F8" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M11.3333 13.3337C12.0697 13.3337 12.6667 12.7367 12.6667 12.0003C12.6667 11.2639 12.0697 10.667 11.3333 10.667C10.597 10.667 10 11.2639 10 12.0003C10 12.7367 10.597 13.3337 11.3333 13.3337Z" stroke="#F1F4F8" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M4.66732 13.3337C5.4037 13.3337 6.00065 12.7367 6.00065 12.0003C6.00065 11.2639 5.4037 10.667 4.66732 10.667C3.93094 10.667 3.33398 11.2639 3.33398 12.0003C3.33398 12.7367 3.93094 13.3337 4.66732 13.3337Z" stroke="#F1F4F8" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex items-end gap-2">
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M11.3327 6L9.24601 7.66667C8.55935 8.21333 7.43268 8.21333 6.74601 7.66667L4.66602 6" stroke="white" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
              </svg>
        ...
        <div className="max-w-[1512px] mx-auto w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-5">
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 22C8.55228 22 9 21.5523 9 21C9 20.4477 8.55228 20 8 20C7.44772 20 7 20.4477 7 21C7 21.5523 7.44772 22 8 22Z" stroke="#444444" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M19 22C19.5523 22 20 21.5523 20 21C20 20.4477 19.5523 20 19 20C18.4477 20 18 20.4477 18 21C18 21.5523 18.4477 22 19 22Z" stroke="#444444" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M2.05078 2.04999H4.05078L6.71078 14.47C6.80836 14.9248 7.06145 15.3315 7.42649 15.6198C7.79153 15.9082 8.24569 16.0603 8.71078 16.05H18.4908C18.946 16.0493 19.3873 15.8933 19.7418 15.6078C20.0963 15.3224 20.3429 14.9245 20.4408 14.48L22.0908 7.04999H5.12078" stroke="#444444" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
        </div>
      </div>
