      ...
      <div className="hidden lg:flex w-full px-10 py-2 relative bg-gray-50 border-t border-violet-50">
        <div className="max-w-360 mx-auto w-full flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <Link href="/custom-made-form" className="text-brand text-base font-semibold leading-6">
              {t('header.customMadeForm')}
            </Link>
            <Link
              href={lp('/printers')}
              className="px-4 py-2 bg-brand rounded-full flex items-center gap-2 text-white text-base font-semibold hover:bg-brand-hover transition-colors"
            >
