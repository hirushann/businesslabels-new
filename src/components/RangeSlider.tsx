    ...
    <div className="flex flex-col gap-4 select-none">
      <div className="relative h-6 flex items-center mb-2 mx-2">
        ...
        <button
          ...
          className="absolute w-5 h-5 bg-white border-2 border-brand rounded-full -ml-2.5 z-10 hover:scale-110 transition-transform cursor-pointer focus:outline-none"
