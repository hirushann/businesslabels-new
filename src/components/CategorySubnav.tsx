  ...
  return (
    <div className="relative">
      ...
      <nav
        ...
        className="relative z-10 grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-4"
      >
        {subcategories.map((category) => {
          ...
          return (
            ...
            >
              ...
              <div className="w-full text-center px-1 md:px-2">
                <span className="block text-sm sm:text-base md:text-xl font-bold leading-[1.2] text-ink transition-colors group-hover:text-brand line-clamp-2">
                  {name}
                </span>
              </div>
            </Link>
