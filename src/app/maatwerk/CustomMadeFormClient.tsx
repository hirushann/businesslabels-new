      ...
      {submitStatus === 'success' ? (
        ...
        <div className="min-h-[70vh] flex flex-col items-center justify-center text-center py-16 px-4">
          ...
          <div className="relative mb-8">
            <div className="w-24 h-24 bg-gradient-to-br from-amber-400 to-orange-500 rounded-full flex items-center justify-center shadow-xl shadow-brand/30">
            ...
            <ol className="flex flex-col divide-y divide-gray-50 px-6 py-2">
              {([
                ...
                <li key={item.step} className="flex items-center gap-4 py-4">
                  <div className="w-9 h-9 rounded-lg bg-brand-soft border border-amber-100 flex items-center justify-center shrink-0 text-brand">
                    {item.icon}
                  </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <a
              href="/"
              className="h-12 px-8 bg-white rounded-full text-neutral-700 text-base font-bold font-sans border border-gray-200 hover:border-amber-300 hover:bg-brand-soft active:scale-[0.98] transition-all flex items-center justify-center"
            >
              {t('backToHome')}
            </a>
          </div>
          ...
          <div className="flex-1 min-w-0 bg-white rounded-xl shadow-[2px_4px_20px_0px_rgba(109,109,120,0.10)] outline outline-1 outline-offset-[-1px] outline-gray-100 flex flex-col overflow-hidden">
            ...
            <div className="px-3 sm:px-6 py-4 bg-white shadow-[2px_6px_20px_0px_rgba(17,17,17,0.04)] outline outline-1 outline-offset-[-1px] outline-gray-100">
              <div className="relative flex justify-between items-center">
                ...
                <div
                  className="absolute h-0.5 bg-brand rounded-full top-[14px] sm:top-[16px] transition-all duration-500"
                ...
                {STEPS.map((step, i) => {
                  ...
                  return (
                    <div key={step} className="flex-1 flex flex-col items-center gap-1.5 z-10">
                      <div className={`size-7 sm:size-8 rounded-full flex justify-center items-center transition-colors ${isCompleted ? 'bg-brand' : isActive ? 'bg-white outline outline-2 outline-offset-[-2px] outline-amber-500' : 'bg-gray-100'}`}>
                        {isCompleted ? (
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-link text-sm italic font-normal">{t('stepProgress', { current: 1, total: 5 })}</span>
                ...
                {SHAPES.map((s) => {
                  ...
                  return (
                    <button
                      ...
                      className={`w-full px-2 sm:px-3 py-4 relative rounded-lg outline outline-1 outline-offset-[-1px] flex flex-col items-center gap-3 transition-all ${active ? 'bg-brand-soft outline-amber-500' : 'bg-slate-50 outline-gray-100'
                        }`}
                    >
                      <span className={`absolute right-3 top-3 size-4 rounded-full border flex-shrink-0 ${active ? 'bg-brand border-brand' : 'bg-white border-gray-300'}`} />
                      {s.preview}
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-link text-sm italic font-normal">{t('stepProgress', { current: 2, total: 5 })}</span>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="relative w-full flex items-center">
                    <input
                      ...
                      className="h-11 pl-5 pr-12 py-3 rounded-[38px] outline outline-1 outline-offset-[-1px] outline-subtle/30 text-copy text-sm w-full bg-white focus:outline-brand transition-all font-normal placeholder:text-subtle"
                    />
                    <div className="absolute right-4 flex flex-col justify-center items-center gap-0.5">
                      ...
                      >
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-3.5">
                          <path d="M4.5 11.25L9 6.75L13.5 11.25" stroke="var(--subtle)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="size-3.5">
                          <path d="M4.5 6.75L9 11.25L13.5 6.75" stroke="var(--subtle)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                      </button>
                    </div>
                  </div>
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-link text-sm italic font-normal">{t('stepProgress', { current: 3, total: 5 })}</span>
              ...
              <div className="flex flex-col gap-4">
                <PrinterModelSelect
                  ...
                  className="h-11 rounded-[38px] px-5 py-3 outline outline-1 outline-offset-[-1px] outline-subtle/30 bg-white text-sm text-copy placeholder:text-subtle font-normal"
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-link text-sm italic font-normal">{t('stepProgress', { current: 4, total: 5 })}</span>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2.5">
                  <p className="flex items-baseline gap-1">
                    <span className="text-copy text-base font-bold">{t('materialType')} </span>
                    <span className="text-subtle text-sm font-normal">{t('optional')}</span>
                  </p>
                      ...
                      return (
                        <button
                          ...
                          className={`px-2 py-2.5 rounded-lg outline outline-1 outline-offset-[-1px] flex items-center gap-2 transition-all ${
                            active ? 'bg-brand-soft/50 outline-amber-500 shadow-sm' : 'bg-[#F6F8FB] outline-[#F3F4F6]'
                          }`}
                        >
                          ...
                          <div className={`size-[18px] rounded-full border shrink-0 flex items-center justify-center transition-colors ${
                            active ? 'bg-brand border-brand' : 'bg-white border-[#D1D5DB]'
                          }`}>
                            {active && (
                          ...
                          <div className="flex items-baseline gap-1 flex-wrap text-left">
                            <span className="text-copy text-sm font-semibold">{mat.label}</span>
                            <span className="text-subtle text-[13px] sm:text-sm font-medium font-['Manrope'] leading-tight">{mat.sub}</span>
                          </div>
                        </button>
                      );
                    })}
                    ...
                    <div className="w-full sm:w-3/5 p-6 sm:p-8 flex flex-col max-h-[85vh]">
                          ...
                          return (
                            <button
                              ...
                              className={`w-full text-left p-4 rounded-xl border-2 transition-all duration-300 group flex items-start gap-4 ${
                                active 
                                  ? 'border-brand bg-brand-soft/50 shadow-md shadow-brand/10' 
                                  : 'border-transparent bg-neutral-50 hover:bg-white hover:border-brand/30 hover:shadow-lg hover:shadow-neutral-200/50'
                              }`}
                            >
                              <div className={`p-3 rounded-xl flex-shrink-0 transition-colors ${
                                active ? 'bg-brand text-white shadow-md' : 'bg-white text-neutral-400 group-hover:text-brand group-hover:bg-brand-soft shadow-sm border border-neutral-100'
                              }`}>
                                <Icon className="size-6" strokeWidth={1.5} />
                              </div>
                              <div className="flex-1 min-w-0 py-1">
                                <h3 className="font-bold text-neutral-800 text-lg mb-1 group-hover:text-brand transition-colors">
                                  {mat.label}
                                </h3>
                              ...
                              <div className={`py-3 flex-shrink-0 transition-all duration-300 ${
                                active
                                  ? 'opacity-100 text-brand scale-100'
                      ...
                      <div className="pt-4 border-t border-neutral-100">
                        ...
                        <DialogClose asChild>
                          <button
                            type="button"
                            className="w-full h-11 bg-brand hover:bg-brand-hover text-white font-semibold rounded-full transition-colors"
                          >
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-link text-sm italic font-normal">{t('stepProgress', { current: 5, total: 5 })}</span>
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="px-5 py-4 rounded-xl outline outline-1 outline-offset-[-1px] outline-zinc-200 text-neutral-700 text-sm font-sans w-full bg-white resize-none focus:outline-brand focus:outline-2 transition-all"
                  />
                </div>
                <button
                  type="submit"
                  disabled={isSubmitting}
                  className="h-12 px-4 py-2.5 bg-brand rounded-[100px] flex justify-center items-center gap-2 hover:bg-brand-hover disabled:opacity-50 active:scale-[0.98] transition-all"
                >
        ...
        <div className="w-full lg:w-96 flex flex-col gap-6 lg:sticky lg:top-24">
          ...
          <div className="bg-white rounded-xl shadow-[2px_4px_20px_0px_rgba(109,109,120,0.06)] outline outline-1 outline-offset-[-1px] outline-gray-100 overflow-hidden">
            ...
            <div className="p-4 flex flex-col gap-4">
                      ...
                      <div className="relative flex items-center justify-center">
                            ...
                            case 'custom':
                              return (
                                <div className="w-32 h-20">
                                  <svg viewBox="0 0 56 32" className="w-full h-full drop-shadow-sm" fill="white" stroke="var(--copy)" strokeWidth={1}>
                        ...
                        {dimH && (
                          <div className="absolute -right-8 top-0 bottom-0 flex items-center gap-1.5 opacity-80">
                            ...
                            <div className="relative w-px h-full bg-line">
                              <div className="absolute top-0 -left-1 w-2.5 h-px bg-line" />
                              <div className="absolute bottom-0 -left-1 w-2.5 h-px bg-line" />
                            </div>
                            <span className="text-subtle text-[13px] font-medium font-manrope leading-none shrink-0" style={{ writingMode: 'vertical-rl' }}>{dimH}</span>
                          </div>
                        )}
                        ...
                        {dimW && (
                          <div className="absolute -bottom-8 left-0 right-0 flex flex-col items-center gap-1.5 opacity-80">
                            ...
                            <div className="relative w-full h-px bg-line">
                              <div className="absolute left-0 -top-1 w-px h-2.5 bg-line" />
                              <div className="absolute right-0 -top-1 w-px h-2.5 bg-line" />
                            </div>
                            <span className="text-subtle text-[13px] font-medium font-manrope leading-none shrink-0">{dimW}</span>
                          </div>
                        )}
                      </div>
                    </div>
              ...
              {/* Your Choices */}
              <div className="flex flex-col gap-4">
                <span className="text-ink text-[18px] font-bold leading-[21.6px]">{t('yourChoices')}</span>
                    ...
                    <div className="w-full flex flex-col gap-3">
                      ...
                      {selectedShape && (
                        <div className="w-full bg-white/50 justify-between items-center flex">
                          <span className="text-copy text-[16px] font-normal leading-[20.8px]">{t('stepShape')}</span>
                          <span className="text-copy text-[16px] font-bold leading-[20.8px]">
                      ...
                      {hasDimensionsFilled && (
                        <div className="w-full bg-white/50 justify-between items-center flex">
                          <span className="text-copy text-[16px] font-normal leading-[20.8px]">{t('stepSize')}</span>
                          <span className="text-copy text-[16px] font-bold leading-[20.8px]">
                      ...
                      {(printerQuery || unknownPrinter) && (
                        <div className="w-full bg-white/50 justify-between items-center flex">
                          <span className="text-copy text-[16px] font-normal leading-[20.8px]">{t('printerLbl').replace(':', '').trim()}</span>
                          <span className="text-copy text-[16px] font-bold leading-[20.8px]">
                      ...
                      {(selectedMaterials.length > 0 || materialCode || unsureMaterial) && (
                        <div className="w-full bg-white/50 justify-between items-center flex">
                          <span className="text-copy text-[16px] font-normal leading-[20.8px]">{t('materialLbl').replace(':', '').trim()}</span>
                          <span className="text-copy text-[16px] font-bold leading-[20.8px]">
                            {unsureMaterial
                              ? 'Unsure'
                              : materialCode
                ...
                <div className="flex gap-4">
                  {(
                    ...
                    <a
                      ...
                      className="flex-1 p-3 bg-slate-100/30 rounded-xl outline outline-1 outline-offset-[-1px] outline-line flex flex-col items-center gap-3 hover:bg-brand-soft transition-colors"
                    >
                      <div className="size-8 bg-brand-soft rounded-lg shadow-[0_1px_2px_-1px_rgba(0,0,0,0.1)] flex justify-center items-center shrink-0">
                        {item.icon}
                      </div>
