...
function SidebarCard({ title, description, children }: { title: string; description: string; children: ReactNode }) {
  return (
    <div className="flex flex-col gap-4 rounded-xl border border-line bg-white p-6 shadow-[2px_4px_20px_0px_rgba(109,109,120,0.06)]">
      ...
      <div className="grid grid-cols-3 gap-4">
        {actions.map((action) => (
          <Link
            key={action.label}
            href={action.href}
            className="flex flex-col items-center justify-center gap-3 rounded-xl border border-gray-100 bg-[#F1F4F84D] p-3 text-center transition-colors hover:border-brand/30 hover:bg-brand-soft"
          >
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-brand-soft shadow-sm">
        ...
        <div className="mx-auto flex max-w-[1440px] flex-col gap-6">
          ...
          <div className="flex flex-col gap-10 lg:flex-row lg:items-start">
            ...
            <aside className="flex w-full flex-col gap-6 lg:sticky lg:top-24 lg:w-96">
              ...
              {/* ICC Color Profiles */}
              <div className="flex flex-col gap-4 rounded-xl border-2 border-[#FFEDD4] bg-[linear-gradient(135deg,var(--brand-soft)_0%,#FFFFFF_100%)] p-6">
                <div className="flex flex-col gap-2">
                  <h2 className="text-[24px] font-semibold leading-9 text-ink">
