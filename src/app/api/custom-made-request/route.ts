 ...
 * Proxy endpoint that forwards custom label requests to Laravel.
 */
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const recaptchaResult = await verifyRecaptcha(recaptchaToken, 'custom_made_form');
    ...
    console.error('Error forwarding custom made request:', error);
