          ...
          <div className="relative w-full h-56 rounded-xl overflow-hidden shadow-md">
            ...
            <div className="absolute left-6 top-6 flex flex-col gap-12">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white text-sm font-semibold leading-5">{t("common.printers")}</span>
              </div>
      ...
      <div className="relative px-10 py-24 bg-white overflow-hidden">
        ...
        <div className="max-w-360 mx-auto flex flex-col gap-12">
          ...
          <div className="flex justify-between items-start">
            <h2 className="text-neutral-800 text-4xl font-bold leading-[48px]">{t("reviewsSection.title")}</h2>
            <div className="flex items-center gap-6">
