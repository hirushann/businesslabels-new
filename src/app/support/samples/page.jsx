    ...
    return (
      <div className="relative bg-white min-h-screen flex items-center justify-center">
        ...
        <div className="max-w-lg mx-auto px-6 py-20 text-center">
          ...
          <h2 className="text-neutral-800 text-3xl font-bold font-['Segoe_UI'] mb-4">{t('successTitle')}</h2>
    ...
    <div className="relative bg-white overflow-hidden min-h-screen">
      ...
      <div className="max-w-[1440px] mx-auto py-10 flex flex-col gap-4">
        ...
        <div className="h-4 inline-flex justify-start items-center gap-2">
          ...
          <span className="text-zinc-500 text-sm font-normal font-['Segoe_UI'] leading-5">{t('breadcrumbSupport')}</span>
          <span className="text-zinc-500 text-sm font-normal font-['Segoe_UI'] leading-5">/</span>
          <span className="text-neutral-700 text-sm font-semibold font-['Segoe_UI'] leading-5">{t('breadcrumbSample')}</span>
        </div>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col lg:flex-row justify-start items-start gap-6 mt-2">
          ...
          <div className="flex-1 min-w-0 bg-white rounded-xl shadow-[2px_4px_20px_0px_rgba(109,109,120,0.10)] outline outline-1 outline-offset-[-1px] outline-slate-100 flex flex-col overflow-hidden">
            ...
            <div className="p-6 flex flex-col gap-6">
                  ...
                  <div className="flex flex-col items-center gap-3">
                    ...
                    <div className="w-56 flex flex-col items-start gap-1">
                      {fileName ? (
                        ...
                        <>
                          <p className="text-neutral-700 text-base font-semibold font-['Segoe_UI']">{t('dropFile')} <span className="text-amber-500 underline">{t('browse')}</span></p>
                          <p className="text-zinc-500 text-sm font-normal font-['Segoe_UI'] leading-5">{t('fileTypes')}</p>
                        </>
                      )}
                    </div>
                  </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  <h2 className="text-neutral-800 text-2xl font-semibold font-['Segoe_UI'] leading-7">{t('printerTitle')}</h2>
                  <p className="text-neutral-700 text-sm font-normal font-['Segoe_UI'] leading-5">{t('printerSubtitle')}</p>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  {printerResults.length > 0 ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                     ...
                     <p className="text-zinc-500 text-sm font-['Segoe_UI'] italic">{t('noPrintersFound', { query: printerQuery })}</p>
                  ) : printerQuery.trim().length === 0 ? (
                     <p className="text-zinc-500 text-sm font-['Segoe_UI']">{t('searchPrinterAbove')}</p>
                  ) : null}
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  <h2 className="text-neutral-800 text-2xl font-semibold font-['Segoe_UI'] leading-7">{t('materialTitle')}</h2>
                  <p className="text-neutral-700 text-sm font-normal font-['Segoe_UI'] leading-5">{t('materialSubtitle')}</p>
                </div>
                ...
                <div className="flex flex-col gap-3">
                  {materialResults.length > 0 ? (
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                     ...
                     <p className="text-zinc-500 text-sm font-['Segoe_UI'] italic">{t('noMaterialsFound', { query: materialQuery })}</p>
                  ) : materialQuery.trim().length === 0 ? (
                     <p className="text-zinc-500 text-sm font-['Segoe_UI']">{t('searchMaterialAbove')}</p>
                  ) : null}
                </div>

                <div className="flex flex-col gap-2 mt-2">
                  <p className="text-neutral-800 text-lg font-semibold font-['Segoe_UI'] leading-5">{t('specialMaterialNeeds')}</p>
                  <textarea name="special_material" value={form.special_material} onChange={handleChange} rows={4} placeholder={t('specialMaterialPlaceholder')} className="self-stretch px-5 py-4 rounded-xl outline outline-1 outline-offset-[-1px] outline-zinc-200 text-base text-neutral-800 placeholder:text-zinc-500 font-['Segoe_UI'] leading-6 resize-none focus:outline-amber-400 focus:outline-2 transition-all" />
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-2">
                  <h2 className="text-neutral-800 text-2xl font-semibold font-['Segoe_UI'] leading-7">{t('requestDetails')}</h2>
                  <p className="text-neutral-700 text-sm font-normal font-['Segoe_UI'] leading-5">{t('requestDetailsDesc')}</p>
                </div>
                <div className="flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    <label className="text-neutral-800 text-lg font-semibold font-['Segoe_UI'] leading-5">{t('application')}</label>
                    <textarea name="application" value={form.application} onChange={handleChange} rows={4} placeholder={t('applicationPlaceholder')} className="self-stretch px-5 py-4 rounded-xl outline outline-1 outline-offset-[-1px] outline-zinc-200 text-base text-neutral-800 placeholder:text-zinc-500 font-['Segoe_UI'] leading-6 resize-none focus:outline-amber-400 focus:outline-2 transition-all" />
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col gap-2">
                      <label className="text-neutral-800 text-lg font-semibold font-['Segoe_UI'] leading-5">{t('country')}</label>
                      <input name="country" value={form.country} onChange={handleChange} placeholder={t('countryPlaceholder')} className="self-stretch h-12 px-5 rounded-[100px] outline outline-1 outline-offset-[-1px] outline-zinc-200 text-base text-neutral-800 placeholder:text-zinc-500 font-['Segoe_UI'] leading-6 focus:outline-amber-400 focus:outline-2 transition-all" />
                    </div>
                  </div>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  <div className="flex flex-col gap-2">
                    <label className="text-neutral-800 text-lg font-semibold font-['Segoe_UI'] leading-5">{t('comments')}</label>
                    <textarea name="comments" value={form.comments} onChange={handleChange} rows={4} placeholder={t('commentsPlaceholder')} className="self-stretch px-5 py-4 rounded-xl outline outline-1 outline-offset-[-1px] outline-zinc-200 text-base text-neutral-800 placeholder:text-zinc-500 font-['Segoe_UI'] leading-6 resize-none focus:outline-amber-400 focus:outline-2 transition-all" />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-neutral-700 text-sm font-normal font-['Segoe_UI'] leading-5">{t('emailConfirm')}</p>
              </div>
              ...
              >
                {isSubmitting ? (
                  <>
                    ...
                    <span className="text-white text-base font-semibold font-['Segoe_UI'] leading-6">{t('sending')}</span>
                  </>
                ) : (
                  <span className="text-white text-base font-semibold font-['Segoe_UI'] leading-6">{t('submitRequest')}</span>
                )}
              </button>
            </div>
          </div>
