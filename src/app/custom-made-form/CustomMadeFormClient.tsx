...
const MATERIALS: Material[] = [
  { id: 'gloss-paper', label: 'Gloss paper', sub: '(Bright, vivid — most popular choice)' },
  { id: 'matte-paper', label: 'Matte paper', sub: '(Clean and modern, no glare)' },
  { id: 'gloss-polyester', label: 'Gloss polyester', sub: '(Waterproof and durable)' },
  { id: 'matte-polyester', label: 'Matte polyester', sub: '(Scratch-resistant, matte finish)' },
  { id: 'transparent', label: 'Transparent', sub: '(See-through, no-label look)' },
  { id: 'silver-polyester', label: 'Silver polyester', sub: '(Metallic appearance)' },
];
                ...
                return (
                  <div key={step} className="w-24 flex flex-col items-center gap-2 z-10">
                    ...
                    <span className={`text-sm font-semibold font-sans ${isActive || isCompleted ? 'text-amber-500' : 'text-zinc-500'}`}>
                      {step === 'Contact' ? t('stepSubmit') : t('step' + step as any)}
                    </span>
                  </div>
                );
              })}
          ...
          <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-6">
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-amber-500 text-sm font-sans">Step 1 of 5</span>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex flex-col items-center gap-1">
                        <span className="text-neutral-700 text-base font-semibold font-sans">{s.id === 'rectangular' ? t('shapeRectangle') : s.id === 'square' ? t('shapeSquare') : s.id === 'round' ? t('shapeCircle') : s.label}</span>
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-amber-500 text-sm font-sans">Step 2 of 5</span>
              ...
              <div className="flex flex-col gap-2">
                ...
                <p className="text-zinc-500 text-sm font-sans leading-5">
                  Have an unusual size or unsure? Enter an estimate and mention it in the notes.
                </p>
              </div>
            </section>
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-amber-500 text-sm font-sans">Step 3 of 5</span>
              ...
              <div className="flex flex-col gap-4">
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  />
                  <span className="text-neutral-700 text-base font-semibold font-sans">I don&apos;t know my printer model</span>
                </label>
              </div>
            </section>
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-amber-500 text-sm font-sans">Step 4 of 5</span>
                <h2 className="text-neutral-800 text-2xl font-semibold font-sans leading-7">{t("selectMaterial")}</h2>
                <p className="text-neutral-700 text-sm font-sans leading-5">Choose the material for your label. Not sure? We&apos;re happy to advise.</p>
              </div>
              <div className="flex flex-col gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    ...
                    className="size-4 accent-amber-500"
                  />
                  <span className="text-neutral-700 text-base font-semibold font-sans">I&apos;m not sure yet — please advise me</span>
                </label>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="h-11 px-5 py-3 rounded-[38px] outline outline-1 outline-offset-[-1px] outline-zinc-500/30 flex items-center gap-2 bg-white">
                    ...
                    <input
                      ...
                      placeholder="Search by material code - e.g. DIA610"
                      className="flex-1 text-zinc-500 text-sm font-sans leading-5 bg-transparent outline-none"
                    />
                  </div>
                  <p className="text-zinc-500 text-sm font-sans leading-5">
                    You already have an item from us and want the same material, or have received samples.
                  </p>
                </div>

                <div className="flex flex-col gap-2.5">
                  <p>
                    <span className="text-neutral-700 text-base font-semibold font-sans">Material type </span>
                    <span className="text-zinc-500 text-sm font-sans">(Optional)</span>
                  </p>
              ...
              <div className="flex items-center gap-2">
                <span className="text-neutral-700 text-base font-sans">Forgot material code?</span>
            ...
            <section className="flex flex-col gap-4">
              <div className="flex flex-col gap-2">
                <span className="text-amber-500 text-sm font-sans">Step 5 of 5</span>
                <h2 className="text-neutral-800 text-2xl font-semibold font-sans leading-7">Where should we send the quote?</h2>
                <p className="text-neutral-700 text-sm font-sans leading-5">Fill in your details — we respond within 1 business day.</p>
              </div>
              <div className="flex flex-col gap-4">
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    <label htmlFor="name" className="text-neutral-800 text-lg font-semibold font-sans leading-5">Name</label>
                    <input
                      id="name"
                      type="text"
                      value={name}
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    <label htmlFor="phone" className="text-neutral-800 text-lg font-semibold font-sans leading-5">Phone</label>
                    <input
                      id="phone"
                      type="tel"
                      value={phone}
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="comments" className="text-neutral-800 text-lg font-semibold font-sans leading-5">Comments</label>
                  <textarea
                    id="comments"
                    value={comments}
                ...
                >
                  <span className="text-white text-base font-semibold font-sans leading-6">
                    {isSubmitting ? 'Sending...' : submitStatus === 'success' ? 'Request Sent' : 'Send Request'}
                  </span>
                </button>
                {submitStatus === 'success' && (
                  <div className="p-4 bg-green-50 text-green-700 text-sm rounded-xl outline outline-1 outline-offset-[-1px] outline-green-200">
                    Your request has been sent! We will get back to you within 1 business day.
                  </div>
                )}
                {submitStatus === 'error' && (
        ...
        <div className="w-full lg:w-96 flex flex-col gap-6 lg:sticky lg:top-6">
          ...
          <div className="bg-white rounded-xl shadow-[2px_4px_20px_0px_rgba(109,109,120,0.06)] outline outline-1 outline-offset-[-1px] outline-gray-100 overflow-hidden">
            <div className="p-4 bg-gray-100 outline outline-1 outline-offset-[-1px] outline-gray-200">
              <h3 className="text-center text-neutral-700 text-2xl font-bold font-sans leading-7">Overview</h3>
            </div>
            <div className="p-4 flex flex-col gap-4">
              {/* Preview */}
              <div className="flex flex-col gap-4">
                <span className="text-neutral-800 text-lg font-bold font-sans leading-5">Preview</span>
                <div className="h-32 flex items-center justify-center pt-2 pr-6">
                  {selectedShape ? (
                    ...
                    <span className="text-center text-zinc-500 text-sm font-medium font-sans leading-4">
                      Choose a shape to see the preview
                    </span>
                  )}
                </div>
              </div>
              ...
              {/* Your Choices */}
              <div className="flex flex-col gap-4">
                <span className="text-neutral-800 text-lg font-bold font-sans leading-5">Your Choices</span>
                <div className="min-h-14">
                  {!hasChoices ? (
                    <span className="text-zinc-500 text-sm font-medium font-sans leading-4">No choices made yet.</span>
                  ) : (
                    <ul className="text-sm text-neutral-700 font-sans space-y-1">
                      ...
                      {(printerQuery || unknownPrinter) && (
                        <li>
                          ...
                          {unknownPrinter ? 'Unknown' : printerQuery}
                        </li>
                      )}
                      {selectedMaterial && (
                        <li>
          ...
          <div className="bg-white rounded-xl shadow-[2px_4px_20px_0px_rgba(109,109,120,0.06)] outline outline-1 outline-offset-[-1px] outline-gray-100 overflow-hidden">
            <div className="p-4 flex flex-col gap-4">
              {(
                [
                  { title: 'Response within 1 business day', sub: 'We get back to you quickly' },
                  { title: 'No obligation', sub: 'The quote is completely free' },
                  { title: 'Personal advice', sub: 'Our specialists are here to help' },
