...
function PrinterCard({ printer }: { printer: Printer }) {
  ...
  return (
    <Link href={href} className="group mx-auto block h-full w-full max-w-88">
      <article className="h-full w-full bg-white rounded-xl shadow-[2px_4px_20px_0px_rgba(109,109,120,0.10)] border border-slate-100 flex flex-col overflow-hidden transition-shadow group-hover:shadow-lg">
        ...
        <div className="p-5 flex flex-col gap-4 flex-1">
          ...
          <div className="flex flex-col gap-3 mt-auto">
            ...
            <span className="px-4 py-2.5 bg-amber-500 rounded-full flex items-center justify-center gap-2 text-white text-base font-semibold font-['Segoe_UI'] leading-6 transition-colors group-hover:bg-amber-600">
