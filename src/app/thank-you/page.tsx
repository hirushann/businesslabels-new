              ...
              {personalName && (
                <div className="w-full p-4 bg-white rounded-xl border border-[#E0E7EE] flex flex-col gap-2 shadow-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#222222] text-[16px] md:text-[18px] font-bold">{t("thankYou.personalInfo")}</span>
                  </div>
              ...
              {fullShippingAddress && (
                <div className="w-full p-4 bg-white rounded-xl border border-[#E0E7EE] flex flex-col gap-2 shadow-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#222222] text-[16px] md:text-[18px] font-bold">{t("thankYou.shippingAddress")}</span>
                  </div>
              ...
              {paymentMethodLabel && (
                <div className="w-full p-4 bg-white rounded-xl border border-[#E0E7EE] flex flex-col gap-2 shadow-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#222222] text-[16px] md:text-[18px] font-bold">{t("thankYou.paymentMethod")}</span>
                  </div>
                  <div className="text-[#444444] text-[15px] md:text-[16px] font-normal leading-relaxed">
                    {paymentMethodLabel}
                  </div>
              ...
              {purchaseReference && (
                <div className="w-full p-4 bg-white rounded-xl border border-[#E0E7EE] flex flex-col gap-2 shadow-sm">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[#222222] text-[16px] md:text-[18px] font-bold">{t("thankYou.purchaseReference")}</span>
                  </div>
                  <div className="text-[#444444] text-[15px] md:text-[16px] font-normal leading-relaxed">
                    {purchaseReference}
                  </div>
