...
function readStringValue(source: Record<string, unknown> | null | undefined, keys: string[]): string {
  if (!source) return "";
...
function readNumberValue(source: Record<string, unknown> | null | undefined, keys: string[]): number | null {
...
export default function ThankYouPage() {
  ...
  const demoShippingStreet = t("thankYou.demoShippingStreet");
  const demoShippingCity = t("thankYou.demoShippingCity");
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      doc.text(t("thankYou.pdfTitle", { number: orderId }), 15, titleY);
      ...
      let infoY = titleY + 6;
      doc.text(`${t("thankYou.pdfDate")}: ${new Date().toLocaleDateString(locale === "nl" ? "nl-NL" : "en-US")}`, 15, infoY);
      ...
      if (purchaseReference) {
        infoY += 6;
        doc.text(`${t("thankYou.purchaseReference")}: ${purchaseReference}`, 15, infoY);
      }
      ...
      <div className="w-full max-w-[1180px] px-4 sm:px-6 lg:px-8 pb-16 flex flex-col justify-start items-center gap-10 z-10">
        ...
        <div className="flex flex-col justify-start items-center gap-6 text-center animate-in fade-in slide-in-from-top-4 duration-500">
          ...
          <div className="flex flex-col gap-3">
            <h1 className="text-ink text-3xl md:text-[40px] font-bold leading-tight font-sans">
              {isSuccess ? t("thankYou.successTitle") : t("thankYou.pendingTitle")}
            </h1>
            <div style={{ color: "var(--copy)", fontSize: "18px", fontFamily: "Segoe UI", fontWeight: 400, lineHeight: "23.40px", wordWrap: "break-word" }}>
        ...
        <div className="w-full bg-white shadow-[2px_4px_20px_rgba(109,109,120,0.10)] rounded-2xl md:rounded-[12px] border border-line p-5 sm:p-6 md:p-8 flex flex-col lg:flex-row gap-8 lg:gap-10 animate-in fade-in zoom-in-95 duration-500 relative">
          ...
          <div className="w-full lg:flex-[1.35] flex flex-col gap-6 min-w-0">
            ...
            <div className="flex flex-col gap-3.5">
              ...
              {discount !== 0 && (
                <div className="flex justify-between items-center text-danger text-[16px] md:text-[18px] font-bold">
          ...
          <div className="w-full lg:flex-1 flex flex-col gap-4 min-w-0">
            ...
            <div className="flex flex-col gap-4">
              ...
              {fullShippingAddress && (
                <div className="w-full p-4 bg-white rounded-xl border border-[#E0E7EE] flex flex-col gap-2 shadow-sm">
                  <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 0 28 28" fill="none" className="shrink-0 text-subtle">
              ...
              {purchaseReference && (
                <div className="w-full p-4 bg-white rounded-xl border border-[#E0E7EE] flex flex-col gap-2 shadow-sm">
                  <div className="flex items-center gap-2">
                    <svg width="24" height="24" viewBox="0 0 29 29" fill="none" xmlns="http://www.w3.org/2000/svg" className="shrink-0">
            ...
            >
              <svg width="18" height="18" viewBox="0 0 18 18" fill="none" className="transition-colors">
                <path d="M8.65215 12.1985C8.85814 12.4047 9.19199 12.4045 9.39785 12.1985L11.6572 9.93921C11.8632 9.73335 11.8632 9.39937 11.6572 9.19351C11.4513 8.98752 11.1175 8.98752 10.9115 9.19351L9.55234 10.5527V6.74219C9.55234 6.45091 9.31614 6.21484 9.025 6.21484C8.73372 6.21484 8.49765 6.45091 8.49765 6.74219V10.5527L7.13851 9.19351C6.93251 8.98752 6.59867 8.98752 6.39267 9.19351C6.18682 9.39937 6.18682 9.73335 6.39267 9.93921L8.65215 12.1985Z" className="fill-brand group-hover:fill-brand-hover transition-colors"/>
